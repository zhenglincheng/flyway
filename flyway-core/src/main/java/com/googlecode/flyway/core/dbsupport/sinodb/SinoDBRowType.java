...
/**
 * SinoDB Dynamic Server-specific row type.
 */
public class SinoDBRowType extends Type {
    /**
     * Creates a new SinoDB Dynamic Server type.
     *
    ...
    protected void doDrop() throws SQLException {
        jdbcTemplate.execute("DROP ROW TYPE " + dbSupport.quote(schema.getName(), name)+" RESTRICT");
    }
}
