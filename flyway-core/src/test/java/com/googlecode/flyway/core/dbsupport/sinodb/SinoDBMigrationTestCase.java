...
public abstract class SinoDBMigrationTestCase {

    /**
     * The base directory for the regular test migrations.
     */
    protected static final String BASEDIR = "migration/sinodbsql";
    ...
    public void repair() throws Exception {
        flyway.setLocations("migration/future_failed_sinodb");
    ...
    public void futureFailedMigrationIgnoreAvailableMigrations() throws Exception {
        ...
        try {
            ...
            if (dbSupport.supportsDdlTransactions()) {
                ...
                assertTrue(e.getMessage().contains("Error executing statement"));
            }
        }
    }
    ...
    public void nonEmptySchemaWithInitOnMigrate() throws Exception {
        ...
        assertEquals(MigrationType.INIT, migrationInfos[0].getType());
    ...
    public void nonEmptySchemaWithInitOnMigrateHighVersion() throws Exception {
        ...
        assertEquals(MigrationState.PREINIT, migrationInfos[0].getState());
    ...
    public void semicolonWithinStringLiteral() throws Exception {
        ...
        assertEquals("Mr. Semicolon+Linebreak;another line",
